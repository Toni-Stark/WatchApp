      ...
      <View style={[tw.flexRow, tw.itemsCenter]}>
        <View style={[tw.p2, tw.borderGray300, { borderWidth: 0.17 }]}>
          ...
          {data.isPublic ? (
            <View style={[tw.absolute, { padding: 0, right: 0, top: 0 }]}>
              <Text style={[tw.bgGreen400, { padding: 1, fontSize: 7, color: colors.background, borderBottomLeftRadius: 3 }]}>共享</Text>
            </View>
          ) : null}
        </View>
        ...
        <View style={[tw.mL4]}>
          <View style={[tw.flexRow]}>
            {/*{!data.isPublic ? <Text style={[tw.itemsCenter, { fontSize: 13, color: colors.notification4 }]}>（共享） </Text> : null}*/}
