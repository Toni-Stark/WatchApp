...
import { Dimensions, Image, KeyboardAvoidingView, Platform, ScrollView, StatusBar, View } from 'react-native';
                ...
                <View style={[tw.selfEnd, tw.flex1, tw.pY3, tw.mB15, tw.mL3, { width: '30%', borderBottomWidth: 1, borderBottomColor: colors.disabled }]}>
                  {userStore.loginVerifyLoading ? (
                    ...
                    <TouchableOpacity onPress={throttle(handleQuerySmsCode)}>
                      <Image style={[{ width: '100%', height: widthThanHeight ? 60 : 19 }]} source={{ uri: userStore.loginVerifyImage }} />
                    </TouchableOpacity>
                  ) : null}
                </View>
              </View>
