...
export const Register: ScreenComponent = observer(
  ({ navigation }): JSX.Element => {
        ...
        <View>
          ...
          <View style={[tw.pX10, tw.itemsCenter]}>
            ...
            <View style={[tw.wFull]}>
              ...
              />
              <View
                style={[tw.justifyCenter, tw.itemsCenter, tw.absolute, { right: 0, width: 90, height: '100%', opacity: userStore.canRegisterBind ? 0.2 : 0.9 }]}
              >
    ...
    return (
      <BaseView useSafeArea={Platform.OS === 'ios'} ref={baseView} scroll={true}>
        {renderContent()}
        {showModal()}
      </BaseView>
    );
