            ...
            <View style={styles.inputLabelView}>
              <TouchableWithoutFeedback onPress={() => console.log('选中')}>
                <View style={[styles.labelView]}>
                  ...
                  <View style={styles.agree}>
                    <TextInput style={styles.input} value={min} keyboardType="numeric" onChangeText={minValueInput} />
                  </View>
                </View>
              ...
              <TouchableWithoutFeedback onPress={() => console.log('选中')}>
                <View style={[styles.labelView]}>
                  ...
                  <View style={styles.agree}>
                    <TextInput style={styles.input} value={max} placeholderTextColor={placeholderColor} keyboardType="numeric" onChangeText={maxValueInput} />
                  </View>
                </View>
              </TouchableWithoutFeedback>
              <TouchableWithoutFeedback onPress={() => console.log('选中')}>
                <View style={[styles.labelView]}>
                  <Text style={styles.labelText}>持续时间</Text>
                  <View style={styles.agree}>
                    <TextInput
                      style={styles.input}
