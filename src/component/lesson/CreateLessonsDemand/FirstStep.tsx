...
import { ClassTypes } from '../../../screen/CardScreens/Lesson/CreateLessons';
...
export const FirstStep: (props: FirstStepType) => JSX.Element = (props) => {
  ...
  return (
    <View style={[tw.flex1]}>
      ...
      {/*  onPress={() => {*/}
      {/*    props.changeSelectMode(1);*/}
      {/*  }}*/}
      {/*>*/}
      {/*  <Text style={{ fontSize: 17, paddingRight: 10, color: colors.placeholder, borderRightWidth: 0.5, borderRightColor: colors.disabled }}>*/}
      {/*    {t('createLessons.selectGrade')}*/}
      {/*  </Text>*/}
      {/*  <Text style={[tw.pX5, { fontSize: 18, color: colors.accent }]}>{props.grade?.slice()[props.selectArray[1]].name}</Text>*/}
      {/*</TouchableOpacity>*/}
      ...
      >
        ...
        {console.log('categories', props.categories?.slice(), props.selectArray)}
      </TouchableOpacity>
    </View>
  );
};
